...
<div class="container-fluid" id="slide">
	...
	<ul>
		...
		<li>
			...
			<img src="http://localhost/e-backend/views/img/slide/default/back_default.jpg">
			
			<div class="slideOpciones slideOpcion1">
				
				<img class="imgProducto" src="http://localhost/e-backend/views/img/slide/slide1/calzado.png" style="top:15%; right:10%; width:45%">				
		...
		<li>
			...
			<div class="slideOpciones slideOpcion2">
				...
				<img class="imgProducto" src="http://localhost/e-backend/views/img/slide/slide2/curso.png" style="top:5%; left: 15%; width: 25%">				
		...
		<li>
			...
			<img src="http://localhost/e-backend/views/img/slide/slide3/fondo2.jpg">
			
			<div class="slideOpciones slideOpcion2">
				
				<img class="imgProducto" src="http://localhost/e-backend/views/img/slide/slide3/iphone.png" style="top:5%; left: 15%; width: 25%">	
		...
		<li>
			...
			<img src="http://localhost/e-backend/views/img/slide/slide4/fondo3.jpg">
			
			<div class="slideOpciones slideOpcion1">
				
				<img class="imgProducto" src="" style="top:15%; right: 10%; width: 45%">
