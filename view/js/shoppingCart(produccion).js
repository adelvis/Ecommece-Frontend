		...
		if(hex_md5(total)== localStorage.getItem("total")){
				...
				$.ajax({
					...
					success: function(respuesta){
						...
						$(".formPayu input[name='confirmationUrl']").attr("value", hiddenPath+"index.php?ruta=end-shopping-payu&payu=true&idUsuario="+idUsuario+"&productos="+productos+"&cantidad="+cantidad);
						$(".formPayu input[name='responseUrl']").attr("value", hiddenPath+"index.php?ruta=profile");
						$(".formPayu input[name='declinedResponseUrl']").attr("value", hiddenPath+"carrito-de-compras");
